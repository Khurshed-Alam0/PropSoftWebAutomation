...
public class TC011_InviteUser_Manager_AcceptThrough_ManuallyAcceptTest extends DriverSetup {

    @Test
    public void inviteUser_Manager_Manually_AcceptTest() throws InterruptedException {
        ...
        WebElement selectPermissionRole = driver.findElement(By.xpath("//body/div[@id='__next']/main[@id='master_container']/div[2]/main[1]/div[1]/form[1]/fieldset[1]/div[1]/section[1]/ul[1]/li[3]/span[1]/button[1]/i[1]"));
