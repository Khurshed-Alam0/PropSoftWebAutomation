...
public class TC012_InviteUser_FieldStaff_AcceptThrough_ManuallyAcceptTest extends DriverSetup {

    @Test
    public void inviteUser_FieldStaff_Manually_AcceptTest() throws InterruptedException {
        Thread.sleep(2000);
     ...
     /*   SidebarPage sidebarPage = new SidebarPage(driver);
       ...
       /* WebElement phoneNumber = driver.findElement(By.id("user_phone_number"));
        ...
        WebElement selectPermissionRole = driver.findElement(By.xpath("//body/div[@id='__next']/main[@id='master_container']/div[2]/main[1]/div[1]/form[1]/fieldset[1]/div[1]/section[1]/ul[1]/li[4]/span[1]/button[1]/i[1]"));
